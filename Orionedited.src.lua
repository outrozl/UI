...
local function MakeDraggable(DragPoint, Main)
    pcall(function()
        ...
        local function OnInputBegan(Input)
            if Input.UserInputType == Enum.UserInputType.Touch or Input.UserInputType == Enum.UserInputType.MouseButton1 then
                ...
                if Input.UserInputType == Enum.UserInputType.Touch then
                    ...
                    TouchPos = Input.Position - Vector2.new(0, 36) -- Offset for mouse input
                end
        ...
        local function OnInputChanged(Input)
            if (Input.UserInputType == Enum.UserInputType.Touch and Input.UserInputState == Enum.UserInputState.Move) or
                (Input.UserInputType == Enum.UserInputType.MouseMovement and Dragging) then
                DragInput = Input
